...
if __name__ == '__main__':
    ...
    video_exist = os.path.exists(args.video_source)
    ...
    cap_params = {}
    frame_processed = 0
    cap_params['im_width'], cap_params['im_height'] = video_capture.get(3),video_capture.get(4)
    ...
    while ret_val:
        ...
        if (cropped_output is not None):
            ...
            if (args.display > 0):
                ...
                print("cropped_output size" , cropped_output.shape)
            ...
            if (args.display > 0):
                if (args.fps > 0):
                    detector_utils.draw_fps_on_image("FPS : " + str(int(fps)),
                                                     output_frame)
                    detector_utils.draw_pose_on_image(output_frame, poses, inferences)
