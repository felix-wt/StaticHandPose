...
def main():
    ...
    menu_choice = input()
    while(menu_choice != '1'
                         '' and menu_choice != '2' and menu_choice != '3'):
    ...
    if(menu_choice == '1'):
        ...
        if not os.path.exists('Pose/' + name_pose):
    ...
    print('You\'ll now be prompted to record the pose you want to add. \n \
                Please place your hand beforeqhand facing the camera, and press any key when ready. \n \
